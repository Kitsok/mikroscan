...
class CredentialManager:
    ...
    def set_master_password(self, master_password: str = None) -> bool:
        ...
        self.master_key = key
        self._current_salt = salt  # Store the salt for consistency
    ...
    def _save_encrypted_credentials(self, credentials: dict):
        ...
        """
        if not self.cipher_suite or not self.master_key:
        ...
        try:
            ...
            if hasattr(self, '_current_salt'):
                ...
                # For backward compatibility, read existing salt or generate new
                if os.path.exists(self.credentials_file):
                    with open(self.credentials_file, 'rb') as f:
                        salt = f.read(16)
                else:
                    salt = os.urandom(16)
                    self._current_salt = salt  # Store for future use
